...
const ENDPOINTS = {
  "long-term": {
    url: "http://api.openisraelisupermarkets.co.il/long_term_health",
    translations: {
  ...
  "short-term": {
    url: "http://api.openisraelisupermarkets.co.il/short_term_health",
    translations: {
      he: "עיבוד נתונים",
      en: "Data Processing",
    },
  ...
  service: {
    url: "http://api.openisraelisupermarkets.co.il/service_health",
    translations: {
